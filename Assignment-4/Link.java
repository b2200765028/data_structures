...
public class Link implements Serializable {
    ...
    void calculateAndSetCost() {
        // TODO: YOUR CODE HERE
       double x =((double)1000/(double)bandwidthInMbps);
       this.setCost(x);
    }
    ...
    public boolean equals(Object o) {
        ...
        Link link = (Link) o;
        return bandwidthInMbps == link.bandwidthInMbps && Double.compare(link.cost, cost) == 0 && Objects.equals(ipAddress1, link.ipAddress1) && Objects.equals(ipAddress2, link.ipAddress2);
    }
}
